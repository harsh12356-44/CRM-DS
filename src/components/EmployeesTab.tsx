            ...
            >
              ...
              <div className="space-y-1.5 pt-2 border-t border-slate-800/60 text-xs">
                ...
                <div className="flex items-center justify-between text-slate-400">
                  ...
                  <div className="flex items-center space-x-1 font-mono text-[11px] text-slate-200 bg-slate-950 px-2 py-0.5 rounded border border-slate-800">
                    <span>{visiblePasswords[emp.id] ? (emp.password || 'Employee@123') : '••••••••'}</span>
                    <button
                      type="button"
                    ...
                    >
                      {visiblePasswords[emp.id] ? <EyeOff className="w-3 h-3 text-amber-400" /> : <Eye className="w-3 h-3 text-blue-400" />}
                    </button>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        placeholder="••••••••"
                        className="w-full bg-slate-800 border border-slate-700 rounded-xl pl-4 pr-10 py-2.5 text-white font-mono font-medium focus:border-blue-500 focus:outline-none"
                      />
                      <button
                        type="button"
                        onClick={() => setShowModalPassword(!showModalPassword)}
                        className="absolute right-3 top-2.5 text-slate-400 hover:text-slate-200 transition"
                        title={showModalPassword ? 'Hide Password' : 'View Password'}
                      >
                        {showModalPassword ? <EyeOff className="w-4 h-4 text-amber-400" /> : <Eye className="w-4 h-4 text-blue-400" />}
                      </button>
                    </div>
                  </div>
                </div>
